    ...
    private function getMain() {
        ...
        echo '<div class="container">
                  <div class="row bordered-bottom">
                      ...
                      <div class="col-md-8">
                          <ul class="navigation">
                              <li><a class="collection-of-information" href="#">' . $this->model->Translate('Collection Of Information') . '</a></li>
                              <li><a class="use-of-personal-data" href="#">' . $this->model->Translate('Use of Personal Data') . '</a></li>
                              <li><a class="disclosure-of-personal-data" href="#">' . $this->model->Translate('Disclosure of Personal Data') . '</a></li>
                              <li><a class="security-measures" href="#">' . $this->model->Translate('Security Measures') . '</a></li>
                              <li><a class="cookies" href="#">' . $this->model->Translate('Cookies') . '</a></li>
                          </ul>
                      </div>
                  </div>';

        echo '<div class="text-center" style="margin-top: 6%;">
                  <h1 class="h-terms">' . $this->model->Translate('Privacy Policy') . '</h1>
                  <h1 class="read-terms">' . $this->model->Translate('Updated as of November 2015') . '</h1>
              ...
              <div class="paddings-terms-content">
                   ...
                   <h1 class="sub-header-terms">
                       ' . $this->model->Translate('You may use our services and products via a mobile device either through mobile applications or mobile optimized websites. This Privacy Policy also applies to such use of our services and products.') . '
                   </h1>
                   ...
                   <h1 class="sub-header-terms">
                       ' . $this->model->Translate('We record and retain records of users\' buying and browsing activities on our platform including but not limited to IP addresses, browsing patterns and buyer behavioral patterns. In addition, we gather statistical information about the Sites and visitors to the Sites including, but not limited to, IP addresses, browser software, operating system, software and hardware attributes, pages viewed, number of sessions and unique visitors (together "Browsing Information").') . '
                   </h1>
                   <h1 class="sub-header-terms">
                       ' . $this->model->Translate('Registration Information, Account Information, Activities Information, Event Information and Browsing Information generally relate to business entities and are together referred to as  business data ("Business Data"). Insofar and only insofar as they constitute personally identifiable data of living individuals, such information are together referred to as  personal data ("Personal Data")') . '
                   </h1>

                   <div id="use-of-personal-data"></div>

                   <h1 class="main-header-terms">' . $this->model->Translate('Use of Personal Data') . '</h1>

                   <h1 class="sub-header-terms">
                       ' . $this->model->Translate('If you provide any Personal Data to us, you are deemed to have authorized us to collect, retain and use that Personal Data for the following purposes:') . '

                       <ul style="list-style-type: disc;" class="items-list">
                           <li>' . $this->model->Translate('verifying your identity;') . '</li>
                           <li>' . $this->model->Translate('processing your registration as a user, providing you with a log-in ID for the Sites and maintaining and managing your registration;') . '</li>
                           <li>' . $this->model->Translate('performing research or statistical analysis in order to improve the content and layout of the Sites, to improve our product offerings and services and for marketing and promotional purposes;') . '</li>
                           <li>' . $this->model->Translate('subject to obtaining your consent in such form as may be required under the applicable law, we may use your name, phone number, residential address, email address and fax number ("Marketing Data") to provide notices, surveys, product alerts, communications and other marketing materials to you relating to goods and services offered by us on the Sites including Gold Suppliers membership, Verified Members membership, Free Members membership (each of Gold Suppliers membership, Verified Members membership, and Free Members membership, a "Membership" and collectively, the "Memberships") the value added services ancillary to the Memberships, and other products and services offered by us from time to time to members of the Sites;') . '</li>
                           <li>' . $this->model->Translate('if you voluntarily submit any information to the Sites for publication on the Sites through the publishing tools, including but not limited to, Company Profile, Product Catalog, Trade Leads, TrustPass Profile and any discussion forum, then you are deemed to have given consent to the publication of such information on the Sites ("Voluntary Information"); and') . '</li>
                           <li>' . $this->model->Translate('making such disclosures as may be required for any of the above purposes or as required by law or in respect of any claims or potential claims brought against us.') . '</li>
                       </ul>
                   </h1>

                   <div id="disclosure-of-personal-data"></div>

                   <h1 class="main-header-terms">' . $this->model->Translate('Disclosure of Personal Data')  . '</h1>
                   ...
                   <h1 class="sub-header-terms">
                       ' . $this->model->Translate('We may provide statistical information to third parties, but when we do so, we do not provide personally-identifying information without your permission.') . '
                   </h1>
                   <h1 class="sub-header-terms">
                       ' . $this->model->Translate('We may share your Account Information with banks or vendors to enable your transactions on the Sites to be completed. In addition, we may use your Account Information to determine your credit-worthiness and, in the process of such determination, we may need to make such Account Information available to banks or credit agencies. While we have in place up-to-date technology and internal procedures to keep your Account Information and other Personal Data secure from intruders, there is no guarantee that such technology or procedures can eliminate all of the risks of theft, loss or misuse.') . '
                   </h1>

                   <div id="security-measures"></div>

                   <h1 class="main-header-terms">' . $this->model->Translate('Security Measures') . '</h1>

                   <h1 class="sub-header-terms">
                       ' . $this->model->Translate('We employ commercially reasonable security methods to prevent unauthorized access to the Sites, to maintain data accuracy and to ensure the correct use of the information we hold.') . '
                   </h1>
                   <h1 class="sub-header-terms">
                       ' . $this->model->Translate('For registered users of the Sites, your Registration Information and Account Information (if any) can be viewed and edited through your account, which is protected by a password. We recommend that you do not divulge your password to anyone. Our personnel will never ask you for your password in an unsolicited phone call or in an unsolicited email. If you share a computer with others, you should not choose to save your log-in information (e.g., user ID and password) on that shared computer. Remember to sign out of your account and close your browser window when you have finished your session.') . '
                   </h1>
                   <h1 class="sub-header-terms">
                       ' . $this->model->Translate('No data transmission over the internet or any wireless network can be guaranteed to be perfectly secure. As a result, while we try to protect the information we hold for you, we cannot guarantee the security of any information you transmit to us and you do so at your own risk.') . '
                   </h1>
