...
class BusinessDevicesView extends DefaultView
{
    ...
    private function getMain() {
        ...
        echo $this->model->Translate('Be in touch with others by using ipad. For non-resident calls laptops have');

        echo '<a id="apps-link" href="http://skype.com">';

        echo $this->model->Translate('Skype');

        echo '</a>';

        echo $this->model->Translate('or');

        echo '<a id="apps-link" href="http://skyp.com">';

        echo $this->model->Translate('Viber');
