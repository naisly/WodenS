...
class View
{
    ...
    /*
     * Function For DOCTYPE, head parts
     * Of HTML File
     */
    protected function DoctypeFile( $page )
    {
        echo '<!DOCTYPE html>
                <html>
                <head>
    ...
    protected function ItemsNamesPart()
    {
    ...
    protected function FilterMenuPart( $item )
    {
        $i = 0;
        $n = 0;
        /*echo '<div class="row">
    ...
    public function GetFooterPart( $page ) {
        echo   '<footer>
                    <div class="container">
                         <div class="row">
